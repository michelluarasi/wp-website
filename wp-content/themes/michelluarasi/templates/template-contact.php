...
<div class="contact-wrapper">
    ...
    <div class="contact-footer">
		    		...
		    		<p>
						...
						<a class="contact-social-link" target="_blank" href="https://www.snapchat.com/add/michelluarasi">
						  <svg class="snapchat" width="48px" height="48px" viewBox="0 0 48 48" version="1.1">
  								<path fill="#FFF" fill-rule="evenodd" d="M24.02 37.88c-1.04 0-2-.16-2.93-.66-1.07-.55-1.95-1.45-3.07-1.9-1.13-.44-2.4-.3-3.55-.1-.5.1-.87.2-1.1-.34-.17-.42-.08-1.1-.43-1.44-.3-.27-1.14-.26-1.55-.35-.45-.12-.9-.24-1.33-.4-.34-.15-.92-.4-1.04-.78-.17-.55.4-.53.8-.63.5-.13.97-.32 1.43-.55.8-.4 1.53-.94 2.17-1.58.84-.84 1.55-1.84 2.05-2.9 1.07-2.25-1.3-2.32-2.7-3.15-.62-.37-1.07-1.03-.27-1.54 1-.63 2.02.55 3.1.2.54-.18.4-.48.38-.98-.04-.63-.08-1.25-.1-1.88-.05-1.15-.07-2.34.2-3.46 1.4-6.08 10.25-7.17 14-2.82 1.6 1.84 1.8 3.94 1.7 6.28 0 .5-.38 2.34-.03 2.7.7.78 2.1-.4 2.88-.24.82.14 1.28.9.6 1.5-.77.68-1.9.66-2.73 1.25-1.15.82-.37 2.16.2 3.1.84 1.34 1.95 2.54 3.33 3.33.4.23.83.42 1.27.57.3.1 1.2.15 1.35.46.22.43-.5.83-.8.97-.9.45-1.9.42-2.82.75-.88.32-.3 1.8-1.22 1.97-.4.06-.96-.17-1.37-.22-.7-.08-1.43-.08-2.13.05-1.2.23-2.12 1.1-3.13 1.75-.96.6-2 1-3.15 1"/>
							</svg>
						</a>
		    ...
		    <div class="contact-meta js-vp_reveal js-fade_in">
						<a class="contact-meta-link" href="/credits">Credits
		            <svg width="8px" height="8px" viewBox="0 0 8 8">
  									<path fill="white" d="M2 0l4 3.5L2 7"/>
		            </svg>
						</a>
						<a class="contact-meta-link" href="/legal">Legal
		            <svg width="8px" height="8px" viewBox="0 0 8 8">
  									<path fill="white" d="M2 0l4 3.5L2 7"/>
		            </svg>
						</a>
