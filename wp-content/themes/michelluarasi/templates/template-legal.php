  ...
  <div class="detail-content">
    <div class="detail-content__body">
        ...
        <div class="content-640">
            ...
            <h2>Sources</h2>
            <h3>Code</h3>
            <p>The WebGL animation on the homepage is based on the open-source code of <a href="https://github.com/spite/codevember-2016" title="Codevember-2016" target="_blank">Codevember-2016</a> and adapted for my purposes.</p>
            <p>Some modules or sections of this website are based on the work from users sharing code-snippets on Codepen. <a href="http://codepen.io/mugi/" title="Codepen" target="_blank">Codepen</a> and adapted for my purposes.</p>
            <p>This Wordpress Template is open-source and available on <a href="https://github.com/michelluarasi/wp-website" title="GitHub" target="_blank">GitHub</a>.</p>
            <hr>
