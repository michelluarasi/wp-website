<footer class="footer">	
	<div class="footer__body">
		<h3 class="footer__body__header">Like what you see?</h3>
		<p class="footer__body__text">Do not hesitate to contact me for any inquires, future collaborations or just to say hello at <a href="mailto:michel@luarasi.com">michel@luarasi.com</a>. I'd love to hear from you!</p>
		<p class="footer_body__notification">PS: I am currently fully booked till the end of November. However, You can expect an answer in the next 5 days.</p>
